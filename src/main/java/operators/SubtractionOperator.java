...
public class SubtractionOperator implements Operator<ExecutionContext, List<String>>
{
    private static final Logger logger = Logger.getLogger(SubtractionOperator.class.getName());
    @Override
    public void execute(ExecutionContext executionContext, List<String> arguments) throws CalculatorException
    {
        ...
        deque.push(result);
        logger.log(Level.FINE, "The subtraction is performed correctly with the result {0}", result);
    }
}
